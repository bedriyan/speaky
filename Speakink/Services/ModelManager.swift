...
private let logger = Logger(subsystem: "com.bedriyan.speakink", category: "ModelManager")
...
final class ModelManager: @unchecked Sendable {
    ...
    init() {
        ...
        modelsDirectory = appSupport.appendingPathComponent("Speakink/Models", isDirectory: true)
