...
private let logger = Logger(subsystem: "com.bedriyan.speakink", category: "PasteService")
...
final class PasteService: @unchecked Sendable {
    ...
    func paste(_ text: String) {
        ...
        // Delay to ensure pasteboard is ready, then simulate Cmd+V
        DispatchQueue.main.asyncAfter(deadline: .now() + Constants.Timing.pasteboardReadyDelay) { [weak self] in
            self?.simulateCmdV()
