...
private let settingsLogger = Logger(subsystem: "com.bedriyan.speakink", category: "Settings")
...
final class AppSettings {
    ...
    var applyWordReplacements: Bool {
        didSet { UserDefaults.standard.set(applyWordReplacements, forKey: "applyWordReplacements") }
    }
    ...
    init() {
        ...
        self.applyWordReplacements = UserDefaults.standard.object(forKey: "applyWordReplacements") as? Bool ?? true
